...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure Agents Code has optimal project context.
...
| Global defaults | `~/.config/agents/AGENTS.md` | User-wide defaults across all projects |
...
- **`#` key shortcut**: During a Agents session, press `#` to have Agents auto-incorporate learnings into AGENTS.md
...
- **Global defaults**: Put user-wide preferences in `~/.config/agents/AGENTS.md`
