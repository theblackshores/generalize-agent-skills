...
Only add information that will genuinely help future Agents sessions. The context window is precious - every line must earn its place.
...
- [ ] Would a new Agents session find this helpful?
